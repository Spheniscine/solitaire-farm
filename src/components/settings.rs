...
use crate::{components::rem, game::{GameState, RankSkin, ScreenState}};
        ...
        div {
            ...
            div {
                ...
                p {
                    ...
                    span {
                        font_size: rem(3.5),
                        "(changes how you compute valid crop groups)"
                    }
                }
            }
            ...
            p {
                class: "copyright",
                "Game rules: Adapted from “Garden Solitaire” by Hazelstorm", br{},
